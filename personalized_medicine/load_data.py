...
train_text_df = pd.read_csv(training_text_file, sep = '\|\|', engine = 'python', header = None, skiprows = 1, names = ['ID', 'Text'])
test_variants_df = pd.read_csv(test_variants_file)
test_text_df = pd.read_csv(test_text_file, sep = '\|\|', engine = 'python', header = None, skiprows = 1, names = ['ID', 'Text'])
